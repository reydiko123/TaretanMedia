...
return [
    ...
    */
    ...
    'configs' => [
        ...
        // Allowlist for article rich text (plan §7.9 / ADR-009 / R-04).
        // Scripts, event handlers, iframes, and unsafe URI schemes are removed.
        'article' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h2,h3,h4,b,strong,i,em,u,s,del,a[href|title|rel],ul,ol,li,p,br,blockquote,figure,figcaption,img[src|alt|width|height],code,pre',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form',
